...
output_struct=plot_train_all_win_cb(stringa_dir,par,ranged_par,ranged_stringa,'window length [ms]'); % this generates Fig 5 panels
output_struct=plot_train_all_win_si_cb(stringa_dir,par,ranged_par,ranged_stringa,'window length [ms]'); % this generates Fig S3 panels
