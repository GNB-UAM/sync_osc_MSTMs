...
set(gcf,'Position',[5         267        1914         702]);
figure_name=[sleepDir filesep 'loro_decodeAprime_' Job.decodeMode '_' Job.decodeType '_longn_v2' '_cb' png_tail '_' names_string];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
...
title({['LORO wake vs. NREM decoding']},'FontWeight','normal','Interpreter','none','FontSize',FontSizeThisCb);
set(gcf,'Position',[5         267        1914         702]);
figure_name=[sleepDir filesep 'loro_decodeAprime_' Job.decodeMode '_' Job.decodeType '_longn_v3' '_cb' png_tail '_' names_string];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
...
figure_name=[sleepDir filesep 'loro_decodeAprime_' Job.decodeMode '_' Job.decodeType '_longn_v4' '_cb' png_tail '_' names_string];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
