function output_struct=multi_all_train_range_anal_ms_cluster_bal_cb(stringa_dir_batch,par,stringa_name)
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name stringa_name '_cb_bal_' names_string '.png']);
end
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name stringa_name '_cb_bal_' names_string '.png'],'-m3');
end
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name stringa_name '_cb_bal_' names_string '.png'],'-m2');
end
