function output_struct=multi_train_range_anal_all_cb_title(stringa_dir_batch,par,ranged_par,ranged_stringa,ranged_stringa_tex)
...
get_field_names_cb_bs; % enough with bs measures for now
...
if 1 % already done for the ss family... actually needs to be done for both ss and ds
    for kk=10
        ...
        for i=1:n_k_ratio
            ...
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(3)) '_m' char(ranged_stringa(2)) '_at_' char(ranged_stringa(1)) '' num2str(i) '_longn_cb_title.png']; % long measure name
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_m' char(ranged_stringa(3)) '_at_' char(ranged_stringa(1)) '' num2str(i) '_longn_cb_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        ...
        for i=1:n_g_exc
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(3)) '_m' char(ranged_stringa(1)) '_at_' char(ranged_stringa(2)) '' num2str(i) '_longn_cb_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(1)) '_m' char(ranged_stringa(3)) '_at_' char(ranged_stringa(2)) '' num2str(i) '_longn_cb_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        ...
        for i=1:n_g_inh
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_m' char(ranged_stringa(1)) '_at_' char(ranged_stringa(3)) '' num2str(i) '_longn_cb_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(1)) '_m' char(ranged_stringa(2)) '_at_' char(ranged_stringa(3)) '' num2str(i) '_longn_cb_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        close all;
    end
