function output_struct=multi_train_anal_win_cluster_cb(dataDir,filenames,stringa,par)
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],'-nocrop');
end
...
pos_this=[0.1061    0.1022    0.8550    0.8328];
if PLOT.print
    figure_name=fullfile(figDir,'sync_all_zs_measabsspearmancorrsorted_color_longn_h_vlines_clipped');
    export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],'-nocrop');
end
...
if ~isempty(xyMDS)
    ...
    if PLOT.print
        ...
        export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],'-m2'); % this doesn't come out nice with xvfb
    end
...
axis off;
if PLOT.print
    figure_name=fullfile(figDir,'sync_all_zs_absspearmancorr_sorted_color_longn_lines_h_clipped');
    export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],'-nocrop');
end
