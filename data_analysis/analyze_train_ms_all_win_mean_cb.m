function output_struct=analyze_train_ms_all_win_mean_cb(stringa_dir_batch,par)
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name '_cb' '_' names_string '.png']);
end
...
for w_ind=1:(length(win_vect))
    if w_ind~=length(win_vect)
        ...
        figure_name=['all_measures_bias_mean' '_w' num2str(w_ind) '_cb' par.png_tail '_' names_string '.png'];
        ...
        set(gcf,'Position',[5         267        1914         702]);
        figure_name=['all_measures_bias_mean' '_w' num2str(w_ind) '_symlog' '_cb' par.png_tail '_' names_string '.png'];
        hgexport(gcf,figure_name,mystyle,'Format','png');
        ...
        figure_name=['all_measures_bias_mean' '_w' num2str(w_ind) '_symlog_longn' '_cb' par.png_tail '_' names_string '.png'];
        ...
        set(gcf,'Position',[5         267        1914         702]);
        figure_name=['all_measures_absbias_mean' '_w' num2str(w_ind) '_cb' par.png_tail '_' names_string '.png'];
        hgexport(gcf,figure_name,mystyle,'Format','png');
    ...
    set(gcf,'Position',[5         267        1914         702]);
    figure_name=['all_measures_cv_mean' '_w' num2str(w_ind) '_cb' par.png_tail '_' names_string '.png'];
    hgexport(gcf,figure_name,mystyle,'Format','png');
    ...
    set(gcf,'Position',[5         267        1914         702]);
    figure_name=['all_measures_abscv_mean' '_w' num2str(w_ind) '_cb' par.png_tail '_' names_string '.png'];
    hgexport(gcf,figure_name,mystyle,'Format','png');
    ...
    figure_name=['all_measures_abscv_mean' '_w' num2str(w_ind) '_longn' '_cb' par.png_tail '_' names_string '.png'];
    hgexport(gcf,figure_name,mystyle_highres,'Format','png');
    ...
    set(gcf,'Position',[5         267        1914         702]);
    figure_name=['all_measures_nan_percent_mean' '_w' num2str(w_ind) '_cb' par.png_tail '_' names_string '.png'];
    hgexport(gcf,figure_name,mystyle,'Format','png');
    ...
    if w_ind~=length(win_vect)
        ...
        if PLOT.print
            ...
            export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png']);
        end
        ...
        if PLOT.print
            ...
            export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],'-m2');
        end
...
if isfield(par,'bias_abscv_pos')
    set(gca,'Position',par.bias_abscv_pos);
        ...
        ylim_this=get(gca,'YLim');
        plot(zeros(1,2),ylim_this,'k:','LineWidth',0.5);
        set(gca,'YLim',ylim_this); % seems to be necessary for some reason
        if PLOT.print
            figure_name=['all_measures_bias_abscv_mean_latex_sel' '_w' num2str(w_ind)];
            hgexport(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],mystyle_highres,'Format','png'); % better to use hgexport since we need to assembly panels
...
xtickangle(gca,45);
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_bias_mean' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle,'Format','png');
...
ylabel('$\mathcal{B}_S$','Interpreter','latex','Rotation',0);
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_bias_mean' '_symlog' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle,'Format','png');
...
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_bias_mean' '_symlog_longn' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
...
figure_name=['all_measures_bias_mean' '_symlog_longn_v2' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
...
xtickangle(gca,45);
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_absbias_mean' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle,'Format','png');
...
xtickangle(gca,45);
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_cv_mean' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle,'Format','png');
...
ylabel('$\mathcal{V}_S$','Interpreter','latex','Rotation',0);
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_abscv_mean' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle,'Format','png');
...
figure_name=['all_measures_abscv_mean_longn' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
...
figure_name=['all_measures_abscv_mean_longn_v2' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle_highres,'Format','png');
...
xtickangle(gca,45);
set(gcf,'Position',[5         267        1914         702]);
figure_name=['all_measures_nan_percent_mean' '_cb' par.png_tail '_' names_string '.png'];
hgexport(gcf,figure_name,mystyle,'Format','png');
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name '_cb' par.png_tail '_' names_string '.png'],'-m2'); % double-size
    hgexport(gcf,[figure_name '_cb' par.png_tail '_hg_' names_string '.png'],mystyle_highres,'Format','png'); % better to use hgexport since we need to assembly panels
end
