function output_struct=multi_all_train_range_anal_bs_cluster_bal_cb(stringa_dir_batch,par,stringa_name)
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name stringa_name '_cb_bs_bal_' names_string '.png']);
end
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name stringa_name '_cb_bs_bal_' names_string '.png'],'-m3');
end
...
if PLOT.print
    ...
    export_fig(gcf,[figure_name stringa_name '_cb_bs_bal_' names_string '.png'],'-m3'); % triple-size
    % hgexport(gcf,[figure_name stringa_name '_cb_bs_bal_' names_string '_hge.png'],mystyle,'Format','png'); % same problem, some symbols are not shown correctly
end
