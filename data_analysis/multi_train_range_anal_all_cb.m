function output_struct=multi_train_range_anal_all_cb(stringa_dir_batch,par,ranged_par,ranged_stringa,ranged_stringa_tex)
...
if 1 % already done for the ss family... actually needs to be done for both ss and ds
    for kk=10
        for i=1:n_k_ratio
            ...
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(3)) '_m' char(ranged_stringa(2)) '_at_' char(ranged_stringa(1)) '' num2str(i) '_longn_cb.png']; % long measure name
            ...
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_m' char(ranged_stringa(3)) '_at_' char(ranged_stringa(1)) '' num2str(i) '_longn_cb.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        ...
        for i=1:n_g_exc
            ...
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(3)) '_m' char(ranged_stringa(1)) '_at_' char(ranged_stringa(2)) '' num2str(i) '_longn_cb.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
            ...
            % title([char(ranged_stringa(2)) '=' num2str(ranged_par2_vect(i),'%.0f') 'Hz'],'FontWeight','normal','Interpreter','none');
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(1)) '_m' char(ranged_stringa(3)) '_at_' char(ranged_stringa(2)) '' num2str(i) '_longn_cb.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        ...
        for i=1:n_g_inh
            ...
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_m' char(ranged_stringa(1)) '_at_' char(ranged_stringa(3)) '' num2str(i) '_longn_cb.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
            ...
            % title([char(ranged_stringa(3)) '=' num2str(ranged_par3_vect(i),'%.0f') 'Hz'],'FontWeight','normal','Interpreter','none');
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(1)) '_m' char(ranged_stringa(2)) '_at_' char(ranged_stringa(3)) '' num2str(i) '_longn_cb.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        close all;
    end
